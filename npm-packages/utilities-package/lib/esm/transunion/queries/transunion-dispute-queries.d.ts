import { CreditBureauFindingsType } from '../constants';
import { ICreditBureau, ILineItem, ITrade, ISummarySection, IPublicRecord } from '../interfaces/credit-bureau.interface';
...
export declare class TransunionDisputeQueries extends TransunionMissing {
