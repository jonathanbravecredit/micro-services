...
exports.TransunionReportSorters = void 0;
const constants_1 = require("../constants");
const transunion_missing_1 = require("../transunion-missing");
class TransunionReportSorters extends transunion_missing_1.TransunionMissing {
    constructor() {
        super();
    }
    /*=====================================*/
    ...
    static sortByCreditReportGroups(tradeLines) {
        return tradeLines.sort((a, b) => {
            ...
            if (!symA || !symB)
                return 0;
            return constants_1.CREDIT_REPORT_GROUPS[symA]['order'] - constants_1.CREDIT_REPORT_GROUPS[symB]['order'];
        });
    }
    /*=====================================*/
    //            DATE OPENED
    ...
    static sortTradelineByPayStatus(tradeLines, positive = false) {
        ...
        return [
            ...tradeLines.sort((a, b) => {
                var _a, _b, _c, _d;
                const statusA = constants_1.POSITIVE_PAY_STATUS_CODES[`${(_b = (_a = a.Tradeline) === null || _a === void 0 ? void 0 : _a.PayStatus) === null || _b === void 0 ? void 0 : _b.symbol}`] ? -1 * sort : 1 * sort;
                const statusB = constants_1.POSITIVE_PAY_STATUS_CODES[`${(_d = (_c = b.Tradeline) === null || _c === void 0 ? void 0 : _c.PayStatus) === null || _d === void 0 ? void 0 : _d.symbol}`] ? -1 * sort : 1 * sort;
                return statusA - statusB;
            }),
        ];
    }
}
exports.TransunionReportSorters = TransunionReportSorters;
