...
import { AccountTypes } from '../interfaces/common-tu.interface';
import { IMergeReport, ITradeLinePartition, ISubscriber, IPublicPartition, IBorrower, IBorrowerAddress, IInquiryPartition } from '../interfaces/merge-report.interface';
