...
class TransunionReportSorters {
    ...
    static sortByCreditReportGroups(tradeLines) {
        return tradeLines.sort((a, b) => {
            ...
            if (!symA || !symB)
                return 0;
            return transunion_1.CREDIT_REPORT_GROUPS[symA]['order'] - transunion_1.CREDIT_REPORT_GROUPS[symB]['order'];
        });
    }
    /*=====================================*/
    //            DATE OPENED
    ...
    static sortTradelineByPayStatus(tradeLines, positive = false) {
        ...
        return [
            ...tradeLines.sort((a, b) => {
                var _a, _b, _c, _d;
                const statusA = transunion_1.POSITIVE_PAY_STATUS_CODES[`${(_b = (_a = a.Tradeline) === null || _a === void 0 ? void 0 : _a.PayStatus) === null || _b === void 0 ? void 0 : _b.symbol}`] ? -1 * sort : 1 * sort;
                const statusB = transunion_1.POSITIVE_PAY_STATUS_CODES[`${(_d = (_c = b.Tradeline) === null || _c === void 0 ? void 0 : _c.PayStatus) === null || _d === void 0 ? void 0 : _d.symbol}`] ? -1 * sort : 1 * sort;
