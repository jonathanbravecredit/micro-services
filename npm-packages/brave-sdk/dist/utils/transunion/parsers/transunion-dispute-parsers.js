...
exports.TransunionDisputeParsers = void 0;
const transunion_missing_1 = require("../transunion-missing");
class TransunionDisputeParsers extends transunion_missing_1.TransunionMissing {
    constructor() {
        super();
    }
    /**
    ...
    static unparseSubscriber(subscriber) {
        ...
        const address = ((_c = (_b = subscriber === null || subscriber === void 0 ? void 0 : subscriber.address) === null || _b === void 0 ? void 0 : _b.street) === null || _c === void 0 ? void 0 : _c.unparsed) ? `${(_e = (_d = subscriber === null || subscriber === void 0 ? void 0 : subscriber.address) === null || _d === void 0 ? void 0 : _d.street) === null || _e === void 0 ? void 0 : _e.unparsed}\n${(_g = (_f = subscriber === null || subscriber === void 0 ? void 0 : subscriber.address) === null || _f === void 0 ? void 0 : _f.location) === null || _g === void 0 ? void 0 : _g.unparsed}`
...
exports.TransunionDisputeParsers = TransunionDisputeParsers;
