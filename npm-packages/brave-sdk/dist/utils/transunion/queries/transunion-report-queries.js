...
class TransunionReportQueries extends transunion_missing_1.TransunionMissing {
    ...
    static getTradelineTypeDescription(partition) {
        var _a;
        if (!partition)
            return transunion_1.AccountTypes.Unknown;
        const description = transunion_1.ACCOUNT_TYPES[`${(_a = partition.accountTypeSymbol) === null || _a === void 0 ? void 0 : _a.toLowerCase()}`];
        return description ? description : transunion_1.AccountTypes.Unknown;
    }
    /**
     ...
     * @returns
     */
    static getTradelineISubscriberByKey(tradeline, subs = []) {
        var _a;
     ...
     * @returns
     */
    static getPublicISubscriberByKey(publicItem, subs = []) {
        var _a;
     ...
     * @returns
     */
    static listISubscribers(report) {
        var _a;
        const ISubscribers = (_a = report.TrueLinkCreditReportType) === null || _a === void 0 ? void 0 : _a.Subscriber;
        if (ISubscribers instanceof Array)
            return ISubscribers;
        if (ISubscribers === undefined)
            return [];
        return [ISubscribers];
    }
    /*=====================================*/
    ...
    static isDataBreachCondition(report, condition) {
        ...
        const IBorrower = (_a = report.TrueLinkCreditReportType) === null || _a === void 0 ? void 0 : _a.Borrower;
     ...
     * @returns
     */
    static getCurrentAddress(IBorrower) {
        const address = IBorrower === null || IBorrower === void 0 ? void 0 : IBorrower.BorrowerAddress;
