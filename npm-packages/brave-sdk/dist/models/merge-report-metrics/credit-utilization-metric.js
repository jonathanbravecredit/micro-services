...
exports.CreditUtilizationMetric = void 0;
const credit_report_metrics_1 = require("./credit-report-metrics");
class CreditUtilizationMetric {
    constructor(report) {
        var _a;
        this.report = report;
        this.tradelines = [];
    ...
    getMetric() {
        ...
        return new credit_report_metrics_1.CreditReportMetric("credit_utilization" /* CreditUtilization */, "Credit Utilization" /* CreditUtilization */, perc, status);
    }
