...
const tradeline_partition_1 = require("./tradeline-partition");
class TrueLinkCreditReportType extends homogenize_data_1.Homogenize {
    ...
    init() {
        ...
        this.TradeLinePartition = this.homogenizeArray(this.TradeLinePartition, tradeline_partition_1.TradeLinePartition);
