...
exports.TransunionReportParsers = void 0;
const transunion_missing_1 = require("../transunion-missing");
const transunion_1 = require("../../_constants/transunion");
class TransunionReportParsers extends transunion_missing_1.TransunionMissing {
    constructor() {
        super();
    }
    /**
    ...
    static unparseName(borrowerName) {
        ...
        if (!name)
            return this.bcMissing;
        let fullName = '';
        for (const key in transunion_1.NAME_MAP) {
...
exports.TransunionReportParsers = TransunionReportParsers;
