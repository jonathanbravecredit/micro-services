...
class TransunionDisputeQueries {
    constructor() { }
    /*===================================*/
    //           SUBJECT RECORDS
    /*===================================*/
    ...
    static listFindingsByType(credit, type) {
        ...
        const filter = type === transunion_1.CreditBureauFindingsType.PublicRecord ? 'pr' : 'tr';
...
TransunionDisputeQueries.resultCodeMap = transunion_1.INVESTIGATION_RESULTS_CODE_MAPPING;
