import { IBorrower, IBorrowerAddress, IBorrowerBirth, ICreditStatement, ICreditScore, IEmployer, IBorrowerName, IBorrowerTelephone, ISocialPartition, IBorrowerBureauIdentifier } from '../../../_types/merge-report';
