...
class ReferralQueries {
    ...
    static getActiveCampaignReferrals(campaign) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.store.query().index(referral_model_1.CAMPAIGNACTIVE_GSI).wherePartitionKey(campaign).execFetchAll();
        });
    }
    static getEligibileReferrals() {
        return __awaiter(this, void 0, void 0, function* () {
            return this.store.query().index(referral_model_1.ELIGIBLE_GSI).wherePartitionKey(1).execFetchAll();
        });
    }
    static getReferralByCode(code) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this.store.query().index(referral_model_1.REFERRAL_CODE_GSI).wherePartitionKey(code).execSingle();
        });
    }
...
ReferralQueries.store = new dynamo_easy_1.DynamoStore(referral_model_1.Referral);
