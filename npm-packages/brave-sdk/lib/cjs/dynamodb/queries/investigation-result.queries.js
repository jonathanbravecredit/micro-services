...
const investigation_result_model_1 = require("../models/investigation-result.model");
...
InvestigationResultQueries.store = new dynamo_easy_1.DynamoStore(investigation_result_model_1.InvestigationResult);
