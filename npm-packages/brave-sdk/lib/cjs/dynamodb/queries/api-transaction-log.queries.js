...
const api_transaction_log_model_1 = require("../models/api-transaction-log.model");
...
APITransactionLogQueries.store = new dynamo_easy_1.DynamoStore(api_transaction_log_model_1.APITransactionLog);
