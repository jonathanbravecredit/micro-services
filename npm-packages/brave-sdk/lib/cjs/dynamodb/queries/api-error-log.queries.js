...
const api_error_log_model_1 = require("../models/api-error-log.model");
...
APIErrorLogQueries.store = new dynamo_easy_1.DynamoStore(api_error_log_model_1.APIErrorLog);
