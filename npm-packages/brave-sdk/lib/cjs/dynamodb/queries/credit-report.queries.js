...
const credit_report_model_1 = require("../models/credit-report.model");
...
CreditReportQueries.store = new dynamo_easy_1.DynamoStore(credit_report_model_1.CreditReport);
