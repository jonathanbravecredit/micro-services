...
import { ICreditMixTLSummary, IRecommendationText } from '../_types/credit-report-metrics';
...
export declare enum Recommendations {
...
export declare const RecommendationConditionalLogic: Record<string, (summary: ICreditMixTLSummary) => boolean>;
export declare const RecommendationValues: Record<string, IRecommendationText>;
