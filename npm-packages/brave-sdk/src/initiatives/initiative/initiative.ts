import { Program, ProgramPrimaryTask, ProgramReasons, TaskCard, ExtendedTaskCard } from '../program/program';
...
export class InitiativeMaker {
  ...
  constructor(
    ...
    const tasks = this.program.programTasks.filter((task: { taskId: string }) => {
