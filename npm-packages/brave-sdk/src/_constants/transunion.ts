...
const condition8 = (summary: ICreditMixTLSummary): boolean => {
...
export const RecommendationConditionalLogic: Record<string, (summary: ICreditMixTLSummary) => boolean> = {
...
export const RecommendationValues: Record<string, IRecommendationText> = {
