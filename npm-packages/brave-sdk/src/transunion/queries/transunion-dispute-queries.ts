...
import { INVESTIGATION_RESULTS_CODE_MAPPING, CreditBureauFindingsType } from '../../_constants/transunion';
import { ICreditBureau, ILineItem, IProduct, ITrade, ISummarySection, IPublicRecord } from '../../_types/credit-bureau';
